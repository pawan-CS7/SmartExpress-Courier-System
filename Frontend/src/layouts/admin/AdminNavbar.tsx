    ...
    <div className="h-16 bg-[#D83626] text-white flex items-center justify-between px-6 shadow-md z-10 sticky top-0">
      ...
      <Link to="/admin/dashboard" className="flex items-center gap-3 hover:opacity-95 transition-opacity">
        ...
        <div className="flex flex-col leading-tight">
          <span className="font-bold text-lg tracking-wide">SmartExpress</span>
          <span className="text-[10px] text-white/80 font-medium tracking-widest uppercase">Staff Portal</span>
        </div>
      </Link>
